...
import co.edu.tdea.bank.domain.ports.in.RegisterAuditLogUseCase;
...
/**
 * Application service â€” appends an immutable audit entry for any significant domain event.
 *
