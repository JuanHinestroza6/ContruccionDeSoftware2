...
/**
 * Application service â€” orchestrates the approval of a loan under review.
 *
 ...
 *   <li>State transition {@code UNDER_REVIEW â†’ APPROVED} is enforced by the domain.</li>
...
public class ApproveLoanService implements ApproveLoanUseCase {
    ...
    public Loan approveLoan(Long loanId,
        ...
        // 3. Approver must be INTERNAL_ANALYST â€” only this role may approve loans
